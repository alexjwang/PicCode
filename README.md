...
### Project Overview
Whiteboarding, coding by hand, and reading code in the form of physical text (via textbook or otherwise) are common practices among programmers and CS students - but it is rather inconvenient when one wishes to test such code. Thus, a method of converting such "physical" code into machine-parsable and runnable "real" code would be very helpful.
